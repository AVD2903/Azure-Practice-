...
Successfully deployed and managed Azure resources using ARM templates in the sandbox resource group `1-228571b6-playground-sandbox`. Verified all disks were created with **ProvisioningState = Succeeded**.

### 📸 Deployment & Verification Screenshot
![ARM template lab: resources and az disk list output](assets/azure-arm-lab.png)

### CLI Verification Output
```bash
az disk list --resource-group 1-228571b6-playground-sandbox --output table
```
| Name       | ResourceGroup                     | Location | Sku             | SizeGb | ProvisioningState |
|------------|-----------------------------------|----------|-----------------|--------|--------------------|
| az104-disk1| 1-228571b6-playground-sandbox    | eastus   | Standard_LRS    | 32     | Succeeded          |
| az104-disk2| 1-228571b6-playground-sandbox    | eastus   | Standard_LRS    | 32     | Succeeded          |
| az104-disk3| 1-228571b6-playground-sandbox    | eastus   | Standard_LRS    | 32     | Succeeded          |
| az104-disk4| 1-228571b6-playground-sandbox    | eastus   | Standard_LRS    | 32     | Succeeded          |
| az104-disk5| 1-228571b6-playground-sandbox    | eastus   | StandardSSD_LRS | 32     | Succeeded          |

---
*Author: Vijay Deshmukh, Anand — Lab record of ARM template deployment and verification.*
